...
QT_MOC_LITERAL(6, 91, 34), // "on_editPreferencesAction_trig..."
QT_MOC_LITERAL(7, 126, 30), // "on_actionSnap_to_angle_toggled"
QT_MOC_LITERAL(8, 157, 7), // "checked"
QT_MOC_LITERAL(9, 165, 29) // "on_actionSnap_to_grid_toggled"

    },
    "GameEditor\0on_actionObjConverter_triggered\0"
    "\0AddSGOToMap\0StaticGameObjectDbInfo&\0"
    "gameObject\0on_editPreferencesAction_triggered\0"
    "on_actionSnap_to_angle_toggled\0checked\0"
    "on_actionSnap_to_grid_toggled"
};
...
void GameEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_editPreferencesAction_triggered(); break;
        case 3: _t->on_actionSnap_to_angle_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->on_actionSnap_to_grid_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
