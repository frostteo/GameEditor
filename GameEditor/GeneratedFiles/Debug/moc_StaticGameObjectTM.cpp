...
const QMetaObject StaticGameObjectTM::staticMetaObject = {
    { &GETable<StaticGameObjectDbInfo>::staticMetaObject, qt_meta_stringdata_StaticGameObjectTM.data,
...
void *StaticGameObjectTM::qt_metacast(const char *_clname)
{
    ...
    return GETable<StaticGameObjectDbInfo>::qt_metacast(_clname);
}

int StaticGameObjectTM::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GETable<StaticGameObjectDbInfo>::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
