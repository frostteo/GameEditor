...
const QMetaObject ControlDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ControlDialog.data,
      qt_meta_data_ControlDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *ControlDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ControlDialog"))
        return static_cast< Ui::ControlDialog*>(const_cast< ControlDialog*>(this));
